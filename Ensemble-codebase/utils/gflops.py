...
parser.add_argument(
    "dataset", type=str, help="0: ImageNet-LT, 1: iNaturalist, 2: Imbalance CIFAR 100"
)
...
parser.add_argument(
    "--reduce_dim", type=str, default="False", help="True: reduce dimension"
)
...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="Percentage of passing each expert: only use this if you are calculating GFLOPs for an EA module. Example: 40.99,9.47,49.54",
)

args = parser.parse_args()

model_name = args.model_name
num_classes_dict = {"0": 1000, "1": 8142, "2": 100}
dataset_name_dict = {
    "0": "ImageNet-LT",
    "1": "iNaturalist 2018",
...
def gflops_normed_linear(m, x, y):
    ...
    total_ops = m.weight.numel() * num_instance + m.weight.size(
        0
    )  # weight normalization can be ignored
