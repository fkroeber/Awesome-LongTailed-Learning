    ...
    def __init__(
        ...
        **kwargs,
        ...
        if num_experts == 1:
            ...
            self.backbone = Expert_ResNet.ResNet(
                ResNet.BasicBlock,
                [1, 1, 1, 1],
                dropout=None,
                num_classes=num_classes,
...
class ResNet32Model(Model):  # From LDAM_DRW
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(num_classes, None)
        if num_experts == 1:
            self.backbone = resnet_cifar.ResNet_s(
            ...
            self.backbone = expert_resnet_cifar.ResNet_s(
                expert_resnet_cifar.BasicBlock,
                [5, 5, 5],
                num_classes=num_classes,
                reduce_dimension=reduce_dimension,
                layer2_output_dim=layer2_output_dim,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if num_experts == 1:
            ...
            self.backbone = init_weights_R50(
                model=self.backbone, weights_path="./model/moco_ckpt.pth.tar"
            )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if num_experts == 1:
            ...
            self.backbone = Expert_ResNeXt.ResNext(
                Expert_ResNeXt.Bottleneck,
                [3, 4, 6, 3],
                groups=32,
                width_per_group=4,
                dropout=None,
...
def init_weights_R50(
    model, weights_path="./model/pretrained_model_places/resnet152.pth"
):
    """Initialize weights"""
...
def init_weights(
    model,
    weights_path="./model/pretrained_model_places/resnet152.pth",
    caffe=False,
    classifier=False,
):
    """Initialize weights"""
