...
class ImageNet(object):
    def __init__(
        self,
        batch_size=60,
        root="/research/dept6/taohu/share/ImageNet/",
        class_balance=False,
        num_works=40,
    ):
        ...
        trainset = LT_Dataset(
            root, train_txt, transform=transform_train, class_balance=class_balance
        )
        testset = LT_Dataset_Test(
            root, test_txt, transform=transform_test, class_map=trainset.class_map
        )
