    ...
    def __init__(
        ...
        *args
        ...
        self.weight = nn.Parameter(
            torch.Tensor(num_classes, feat_dim).cuda(), requires_grad=True
        )
...
def create_model(
    ...
    *args
    ...
    print(
        "Loading Causal Norm Classifier with use_effect: {}, num_head: {}, tau: {}, alpha: {}, gamma: {}.".format(
            str(use_effect), num_head, tau, alpha, gamma
        )
    )
    clf = Causal_Norm_Classifier(
        num_classes,
        feat_dim,
