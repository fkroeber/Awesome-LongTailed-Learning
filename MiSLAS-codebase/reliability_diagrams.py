...
def _reliability_diagram_subplot(
    ...
    if draw_order == True:
        ...
        acc_plt = ax.bar(
            ...
            bottom=0,
            width=widths,
            color=sns.color_palette("Blues", 10)[4],
            edgecolor="white",
            alpha=1.0,
            linewidth=5,
            label="Accuracy",
        ...
        gap_plt = ax.bar(
            ...
            width=widths,
            color=sns.color_palette("Blues", 10)[7],
            edgecolor="white",
            linewidth=5,
            label="Gap",
        )
...
def _reliability_diagram_combined(
    ...
    _reliability_diagram_subplot(
        ax, bin_data, draw_ece, draw_bin_importance, title=title, xlabel="Confidence"
    )
